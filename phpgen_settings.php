...
{
    $result = array();
    $result[] = array('caption' => 'Informar problema', 'short_caption' => 'Problemas', 'filename' => 'dispositivo.php', 'name' => 'dispositivo', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
