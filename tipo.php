 ...
 */
    ...
    class tipoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Tipos');
            $this->SetMenuLabel('Tipos de problemas');
    ...
    try
    {
        $Page = new tipoPage("tipo", "tipo.php", GetCurrentUserPermissionSetForDataSource("tipo"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("tipo"));
